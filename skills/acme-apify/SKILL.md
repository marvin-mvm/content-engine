---
name: acme-apify
description: "Scrape Instagram/TikTok/Facebook/YouTube posts and pull 7-day analytics. Platform auto-detected. Auth pre-wired."
metadata:
  {
    "openclaw":
      {
...
Supported platforms: **YouTube, Instagram, TikTok, Facebook** — auto-detected from URL.
Social URLs only. Articles → use `acme-firecrawl`.
